...
call s:hi("Comment",        s:clear,     s:b_black, s:clear)
...
call s:hi("LineNr",         s:clear,     s:b_black, s:clear)
...
call s:hi("SpellBad",       s:clear,     s:clear,   s:green)
...
call s:hi("Type",           s:clear,     s:green,   s:clear)
